        ...
        <div class="row justify-content-evenly align-items-center">
          ...
          <div class="col-md-2 col-2 mt-0 d-none d-sm-block">
            ...
            <ul class="nav flex-column">
              ...
              <li class="nav-item mb-0"><a href="#" class="nav-item p-0 text-white text-decoration-none">Mi historial de citas</a></li>
            </ul>
          </div>
          <div class="col-md-2 col-2 mt-0 d-none d-sm-block">
            ...
            <ul class="nav flex-column">
              ...
              <li class="nav-item mb-0"><a href="#" class="nav-item p-0 text-white text-decoration-none">Visítanos</a></li>
            </ul>
          </div>
          <div class="col-md-2 col-2 mt-0 mb-5 d-none d-sm-block">
            ...
            <ul class="nav flex-column">
              ...
              <li class="nav-item mb-0">08:00 a.m. a 8:00 p.m.</li>
              <li class="nav-item mb-0">Sábado y Domingo</li>
              <li class="nav-item mb-0">08:00 a.m. a 2:00 p.m.</li>
            </ul>
          </div>
          <div class="col-md-2 col-2 mt-0">
